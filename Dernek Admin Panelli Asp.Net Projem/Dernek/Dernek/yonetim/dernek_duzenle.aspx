<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dernek_duzenle.aspx.cs" Inherits="Dernek.yonetim.dernek_duzenle" EnableEventValidation="false" ValidateRequest="false" %>
...
<head runat="server">
    <title>Admin Paneli-Dernek Bilgi Güncelleme</title>
...
<body>
    ...
    <div>
        ...
        <div class="yanyana">Dernek Bilgi Düzenleme</div>
        <div class="yanyana">
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">Bilgi İçeriği</td>
                    <td class="auto-style3">:</td>
                    <td>
