<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yeni_menu.aspx.cs" Inherits="Dernek.yonetim.yeni_menu" ValidateRequest="false" EnableEventValidation="false" %>
...
<head runat="server">
    <title>Admin Paneli-Yeni Menü</title>
...
<body>
    ...
    <div>
        ...
        <div class="yanyana">Menü Yeni Bilgi Ekleme</div>
        <div class="yanyana">
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style4">Menü İçeriği</td>
