<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haber_duzenle.aspx.cs" Inherits="Dernek.yonetim.haber_duzenle" ValidateRequest="false" EnableEventValidation="false" %>
...
<head runat="server">
    <title>Admin Paneli-Haber Bilgi Güncelleme</title>
...
<body>
    ...
    <div>
        ...
        <div class="yanyana">Haber Bilgileri Düzenleme</div>
        <div class="yanyana">
           
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2">Haber Başlığı</td>
