<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yeni_haber.aspx.cs" Inherits="Dernek.yonetim.yeni_haber" ValidateRequest="false"  EnableEventValidation="false"%>
...
<head runat="server">
    <title>Admin Paneli-Yeni Haber</title>
...
<body>
    ...
    <div>
        ...
        <div class="yanyana">Haber Yeni Bilgi Ekleme</div>
        <div class="yanyana">
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style3">&nbsp;</td>
                    <td>
                        <asp:Button ID="btnkaydet" runat="server" OnClick="btnkaydet_Click" Text="Kaydet" style="height: 26px" />
                        &nbsp;&nbsp;&nbsp;
