...
{
    public partial class yeni_menu : System.Web.UI.Page
    {
        ...
        protected void btnkaydet_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                OleDbCommand ekle = new OleDbCommand("insert into menuler (Ad,icerik) values (@ad,@icerik)", con);
                ekle.Parameters.AddWithValue("@ad", tbbaslik.Text);
                ekle.Parameters.AddWithValue("@icerik", tbicerik.Text);
                ekle.ExecuteNonQuery();
                Response.Write("<script lang='JavaScript'>alert('Menü Bilgileri başarıyla kaydedilmiştir...');</script>");
                con.Close();
            }
        }
