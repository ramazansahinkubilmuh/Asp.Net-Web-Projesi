...
{
    public partial class yeni_duyuru : System.Web.UI.Page
    {
        ...
        protected void btnkaydet_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                con.Open();
                OleDbCommand ekle = new OleDbCommand("insert into duyurular (Ad,icerik) values (@ad,@icerik)", con);
                ekle.Parameters.AddWithValue("@ad", tbbaslik.Text);
                ekle.Parameters.AddWithValue("@icerik", tbicerik.Text);
                ekle.ExecuteNonQuery();
                Response.Write("<script lang='JavaScript'>alert('Duyuru Bilgileri başarıyla kaydedilmiştir...');</script>");
                con.Close();
                tbbaslik.Text = "";
                tbicerik.Text = "";
            }
