    ...
    public partial class menu_duzenle : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                con.Open();
                OleDbCommand cmd = new OleDbCommand("Select * from menuler where id=" + sid, con);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            sorgu.CommandText = "UPDATE menuler SET Ad=@ad, icerik=@icerik WHERE id=" + sid;
            sorgu.Parameters.AddWithValue("@ad", tbbaslik.Text);
            sorgu.Parameters.AddWithValue("@icerik", tbicerik.Text);
            sorgu.ExecuteNonQuery();
            Response.Write("<script lang='JavaScript'>alert('Menü Bilgileri başarıyla güncellenmiştir...');</script>");
            baglanti.Close();
            tbbaslik.Text = "";
            tbicerik.Text = "";
        }
