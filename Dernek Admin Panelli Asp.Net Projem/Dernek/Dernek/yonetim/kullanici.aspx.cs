...
namespace Dernek.yonetim
{
    public partial class kullanici : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            sorgu.CommandText = "delete from kullanici WHERE id=" + sid;
            sorgu.ExecuteNonQuery();
            baglanti.Close();
            Response.Redirect("kullanici.aspx");
            Response.Write("<script lang='JavaScript'>alert('Kayıt Silinmiştir...');</script>");
        }
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("kullanici_duzenle.aspx?id=" + id);
        }
    }
}