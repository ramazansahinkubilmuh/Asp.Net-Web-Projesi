<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iletisim.aspx.cs" Inherits="Dernek.iletisim" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <div class="bosluk">
                    ...
                    <div class="font">Telefon : <%#Eval("telefon") %></div>
                    <div class="font">Fax : <%#Eval("fax") %></div>
                    <div class="font">Adres : <%#Eval("adres") %></div>
                </div>
            </ItemTemplate>
        </asp:Repeater>
    </div>
